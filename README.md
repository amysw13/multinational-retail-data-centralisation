...
![Project_schematic](img/Multinational_data_transparent.png "Schematic of project design")
...
![Sales_data_ERD](img/Sales_data_ERD.png "Entity Relationship diagram of STAR-based schema centralised database")
