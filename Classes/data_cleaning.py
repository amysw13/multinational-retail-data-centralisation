...
class DataCleaning:
    ...
    def clean_user_data(self, user_df : pd.DataFrame):
        ...
        '''
        # try block for error handling during data cleaning
        try:
            ...
            print(f"An error occurred during user data cleaning: {e}")
            # Return None or an empty DataFrame to indicate failure
            return pd.DataFrame()
    ...
    def clean_card_data(self, card_df : pd.DataFrame):
        ...
        try:
            ...
            print(f"An error occurred during card data cleaning: {e}")
            return pd.DataFrame()

    def clean_store_data(self, stores_df : pd.DataFrame):
        '''
        ...
        try:
            ...
            print(f"An error occurred during store details data cleaning: {e}")
            return pd.DataFrame()
        
    def convert_product_weights(self, product_df : pd.DataFrame):
        '''
        ...
        try:
            ...
            print(f"An error occurred during product weight conversion: {e}")
            return pd.DataFrame()
        
    def clean_products_data(self, product_df : pd.DataFrame):
        '''
        ...
        try:
            ...
            print(f"An error occurred during products data cleaning: {e}")
            return pd.DataFrame()
    ...
    def clean_orders_data(self, orders_df : pd.DataFrame):
        ...
        try:
            ...
            print(f"An error occurred during order data cleaning: {e}")
            return pd.DataFrame() 
          
    def clean_events_data(self, events_df : pd.DataFrame):
        '''
        ...
        try:        
            ...
            print(f"An error occurred during events data cleaning: {e}")
            return pd.DataFrame()
